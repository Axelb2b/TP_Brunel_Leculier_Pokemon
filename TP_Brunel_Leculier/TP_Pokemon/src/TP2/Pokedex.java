...
public class Pokedex {
			...
			public ArrayList<Pokemon> getPokemonBase(){
				return this.pokemon_base;
			}
			
			public void creer_pokemon_base(){
				for(int i = 0;i<this.listePokemons.size();i++) {
					if (this.listePokemons.get(i).getEvolution_precedente() == null) {
						this.pokemon_base.add(this.listePokemons.get(i));
					}
				}
			}
