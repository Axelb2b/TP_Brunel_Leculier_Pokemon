...
public class Pokemon implements Serializable {
	...
	public Pokemon(int pc,int pv,String type1,String type2, String nom, String evolution_precedente,String evolution_suivante,int niveauEvolution,int niveau,Pokedex pokedex) {
	...
	public ArrayList<Object> attaque() {
		...
		if(this.getTypes().get(1)!=null) {
			System.out.println("Quel attaque voulez vous faire ?\n1 -> "+this.getTypes().get(0)+"\n2 -> "+this.getTypes().get(1));
